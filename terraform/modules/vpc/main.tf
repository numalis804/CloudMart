# VPC Module - CloudMart Networking Layer
# Creates a production-ready VPC with multi-AZ public and private subnets
...
# Private Route Tables (one per AZ for future flexibility)
...
resource "aws_network_acl" "private" {
  ...
  # Allow ephemeral ports from internet (for NAT return traffic)
  ingress {
    protocol   = "tcp"
    rule_no    = 110
    action     = "allow"
